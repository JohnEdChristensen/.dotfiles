...
nmap("<c-cr>", "<cmd>QuartoSend<cr>")
nmap("<s-cr>", "<cmd>QuartoSend<cr>")
imap("<c-cr>", "<esc><cmd>QuartoSend<cr>i")
imap("<s-cr>", "<esc><cmd>QuartoSend<cr>i")

-- send code with Enter and leader Enter
vmap("<cr>", "<cmd>QuartoSend<cr>")
nmap("<leader><cr>", "<cmd>QuartoSend<cr>")
